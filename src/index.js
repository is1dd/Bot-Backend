...
bot.onText(/\/start/, async(msg) => {
    ...
    bot.sendMessage(chatId, 'Welcome! Please click /login to authenticate.');
    bot.sendMessage(chatId, "Here is our listed commands to utilize our bot commands  :)\n/add        -> For adding new task \nExample -> /add title description... \n/get         -> For getting all tasks \nExample -> /get, /get status (todo, pending, done)\n/update  -> For update a task \nExample -> /update title status (status - todo, pending, done) \n/delete    -> For delete a task \nExample -> /delete title \n\nPlease go through the commands mentioned 😊😊😊");
